...
if(COption::GetOptionString("primecorp", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
{
	...
	{
		$iblockCode = "primecorp_partners_".WIZARD_SITE_ID;
		...
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("PARTNERS_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/page_blocks/main-page.php", array("PARTNERS_IBLOCK_ID" => $iblockID));
