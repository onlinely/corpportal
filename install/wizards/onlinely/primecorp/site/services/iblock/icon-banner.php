...
if(COption::GetOptionString("primecorp", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
{
	if ($wizard->GetVar('rewriteIndex', true))
	{
		$iblockCode = "primecorp_icon-banner_".WIZARD_SITE_ID;
		$iblockType = "primecorp_iblock";

		$rsIBlock = CIBlock::GetList(array(), array("XML_ID" => $iblockCode, "TYPE" => $iblockType));
		$iblockID = false;
		if ($arIBlock = $rsIBlock->Fetch())
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("ICON-BANNER_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}
...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/icon-banner.xml";
$iblockCode = "primecorp_icon-banner_".WIZARD_SITE_ID;
$iblockType = "primecorp_iblock";
...
WizardServices::IncludeServiceLang("icon-banner.php", $lang);

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/page_blocks/main-page.php", array("ICON-BANNER_IBLOCK_ID" => $iblockID));
