...
if(COption::GetOptionString("primecorp", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
{
	...
	{
		$iblockCode = "primecorp_services_".WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/page_blocks/main-page.php", array("SERVICES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/index.php", array("SERVICES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/.left.menu_ext.php", array("SERVICES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/.bottomtwo.menu_ext.php", array("SERVICES_IBLOCK_ID" => $iblockID));