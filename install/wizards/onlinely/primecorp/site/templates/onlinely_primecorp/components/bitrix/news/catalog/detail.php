    ...
    <div class="content">
        <?$ElementID = $APPLICATION->IncludeComponent(
            ...
            [
                ...
                'PRODUCT_ADD_INFO' => $arParams['PRODUCT_ADD_INFO'],
	            'PRODUCT_DELIVERY' => $arParams['PRODUCT_DELIVERY'],
                'MESS_DELIVERY_TAB' => $arParams['MESS_DELIVERY_TAB'],
                'MESS_ADD_INFO_TAB' => $arParams['MESS_ADD_INFO_TAB'],
            ],
            $component
        );?>
    </div> <!-- content -->
                ...
                <div class="page-block block-catalog-list" style="width: 100%;">
                    <div class="page-block__head">
                        <div class="page-block__title">
                            <h2><?=GetMessage('OTHER_PRODUCTS_TITLE')?></h2>
                        </div>
                        <div class="page-block__link">
                            <a href="<?=SITE_DIR?>catalog/"><?=GetMessage('CATALOG_LINK')?></a>
                        </div>
                    </div>
                    <?$listShowPropertyId = \Bitrix\Iblock\Model\PropertyFeature::getListPageShowPropertyCodes($arParams["IBLOCK_ID"]);
                    ...
                    if (empty($listShowPropertyCode)) {
                        $dbProperties = CIBlockProperty::GetList(
                            ['SORT' => 'ASC'],
                            ["IBLOCK_ID" => $arParams["IBLOCK_ID"]]
                        );
                        while ($arProperty = $dbProperties->Fetch()) {
                            $listShowPropertyCode[] = $arProperty['CODE'];
                        }
                    }                    
                ?>
                    <?$APPLICATION->IncludeComponent(
                        ...
                        [
                            ...
                            'PROPERTY_CODE' => (!empty($listShowPropertyCode) ? $listShowPropertyCode : $arParams['LIST_PROPERTY_CODE']),
                            'SET_TITLE' => 'N',
                            'SET_BROWSER_TITLE' => 'N',
                            'SET_META_KEYWORDS' => 'N',
