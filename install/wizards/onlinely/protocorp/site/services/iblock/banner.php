...
if(COption::GetOptionString("protocorp", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
{
	...
	{
		$iblockCode = "protocorp_banner_".WIZARD_SITE_ID;
...
WizardServices::IncludeServiceLang("banner.php", $lang);

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/page_blocks/main-page.php", array("BANNER_IBLOCK_ID" => $iblockID));
