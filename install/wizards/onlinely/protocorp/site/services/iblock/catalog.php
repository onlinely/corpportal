...
if(COption::GetOptionString("protocorp", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
{
	...
	{
		$iblockCode = "protocorp_catalog_".WIZARD_SITE_ID;
		$iblockType = "protocorp_catalog";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/page_blocks/main-page.php", array("CATALOG_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("CATALOG_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/.left.menu_ext.php", array("CATALOG_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/.bottomone.menu_ext.php", array("CATALOG_IBLOCK_ID" => $iblockID));
