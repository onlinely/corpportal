...
if(COption::GetOptionString("protocorp", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
{
	...
	{
		$iblockCode = "protocorp_projects_".WIZARD_SITE_ID;
...
WizardServices::IncludeServiceLang("projects.php", $lang);

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/page_blocks/main-page.php", array("PROJECTS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/projects/index.php", array("PROJECTS_IBLOCK_ID" => $iblockID));
