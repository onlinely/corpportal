...
if(COption::GetOptionString("protocorp", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
{
	if ($wizard->GetVar('rewriteIndex', true))
	{
		$iblockCode = "protocorp_icon-banner_".WIZARD_SITE_ID;
		$iblockType = "protocorp_iblock";
